                ...
                <div class="card-body">
                    ...
                    @method('put')
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="judul" type="text" placeholder="judul pengumuman" name="judul" value="{{ old('judul',$pengumuman->judul) }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="text-danger">*</label>
                            <label for="isi">Isi Pengumuman</label>
                            <textarea name="isi" id="isi" cols="30" rows="10" class="form-control ckeditor" required>{{ old('isi',$pengumuman->isi) }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="text-danger">*</label>
