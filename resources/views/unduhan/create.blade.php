...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Dashboard / File Unduhan / Tambah File Unduhan</h1>
    </div>
    <!-- Content Row -->
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    @csrf
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="nama_file" type="text" placeholder="Nama file" name="nama_file" value="{{ old('nama_file') }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="text-danger">*</label>
